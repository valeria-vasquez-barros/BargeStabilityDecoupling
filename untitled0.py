...
plt.hlines(y=assist_old,xmin=0.5,xmax=1.5,colors='r',linestyles='solid')
plt.hlines(y=assist_new,xmin=2,xmax=3,colors='r',linestyles='dashed')
plt.hlines(y=lidar,xmin=3.5,xmax=4.5,linestyles='dotted')
plt.xlim(0,10)
plt.xticks([])
plt.legend(['Original ASSIST','Interpolated ASSIST','WindCube V2'])
plt.ylabel('Height (m)')
